...
<!-- Modal satisfaction -->
<div class="modal fade" id="modal-satisfaction-client" tabindex="-1" role="dialog" aria-labelledby="modal-satisfaction-client" aria-hidden="true">
...
<!-- Modal planning -->
<div class="modal fade" id="modal-planning" tabindex="-1" role="dialog" aria-labelledby="modal-change-projet" aria-hidden="true">
	<div class="modal-dialog">
	    <div class="modal-content">
	        <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-close"></i></button>
...
<!-- Modal livrables -->
<div class="modal fade" id="modal-livrable" tabindex="-1" role="dialog" aria-labelledby="modal-livrable" aria-hidden="true">
	        ...
	        <div class="modal-body">
	           	<table border="1" style="width: 100%; text-align: center; font-size: 16">
					<tr>
						...
						<td style="width: 50%"><input type="text" class="form-control input-modal" value="Ceci est un long commentaire"></td>
					</tr>  
					<tr>
						<td>							
							<select style="margin: 0" class="form-control">
						...
						<td><input type="text" class="form-control input-modal" value="Ceci est un long commentaire"></td>
					</tr> 
					<tr>
						<td>
							<select style="margin: 0" class="form-control">
